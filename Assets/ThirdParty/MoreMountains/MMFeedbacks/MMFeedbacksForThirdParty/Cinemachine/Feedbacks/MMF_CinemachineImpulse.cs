...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMF_CinemachineImpulse : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            Debug.LogWarning(
                "Due to a severe bug in the current versions of Cinemachine, this feedback has been disabled. It should be fixed before the end of March 2022, according to Unity. Note that it does still work on 'old' MMFeedbacks, just not on MMF_Player for now. Yes, it's annoying. In the meantime you can use the CinemachineImpulseSource feedback.");
