...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMCinemachineCameraShaker : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Use this method to shake the camera for the specified duration (in seconds) with the default amplitude and
        ///     frequency
        /// </summary>
        ...
        {
            MMCameraShakeEvent.Trigger(TestDuration, TestAmplitude, TestFrequency, 0f, 0f, 0f);
        }
    }
}