...
{
    /// <summary>
    ///     This feedback will let you output a message to the console, using a custom MM debug method, or Log, Assertion,
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            switch (DebugLogMode)
            {
                ...
                case DebugLogModes.DebugLogTime:
                    var color = "#" + ColorUtility.ToHtmlStringRGB(DebugColor);
