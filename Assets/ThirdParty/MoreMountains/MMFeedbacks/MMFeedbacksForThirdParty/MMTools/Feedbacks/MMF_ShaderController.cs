...
{
    /// <summary>
    ///     This feedback will let you control values on a target ShaderController, letting you modify the behaviour and aspect
    ///     of a shader driven material at runtime
    /// </summary>
    [AddComponentMenu("")]
    ...
    public class MMF_ShaderController : MMF_Feedback
    {
        ...
        {
            if (!Active || !FeedbackTypeAuthorized || TargetShaderController == null) return;
            ...
            foreach (var shaderController in TargetShaderControllerList)
        ...
        protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
        {
            ...
            foreach (var shaderController in TargetShaderControllerList) shaderController.Stop();
        }
        ...
        protected override void CustomReset()
        {
            ...
            foreach (var shaderController in TargetShaderControllerList) PerformReset(shaderController);
        }
