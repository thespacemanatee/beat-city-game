...
{
    /// <summary>
    ///     This feedback will trigger a post processing moving filter event, meant to be caught by a
    ///     MMPostProcessingMovableFilter object
    /// </summary>
    [AddComponentMenu("")]
    [FeedbackHelp(
    ...
    public class MMFeedbackPPMovingFilter : MMFeedback
    {
        ...
        [Tooltip("the channel to target")] public int Channel;
