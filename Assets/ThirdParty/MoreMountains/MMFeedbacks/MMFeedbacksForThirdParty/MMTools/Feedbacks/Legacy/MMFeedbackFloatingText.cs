...
namespace MoreMountains.Feedbacks
{
    ...
    ///     your own.
    ///     Using that feedback will always spawn the same text. While this may be what you want, if you're using the Corgi
    ///     Engine or TopDown Engine, you'll find dedicated versions
