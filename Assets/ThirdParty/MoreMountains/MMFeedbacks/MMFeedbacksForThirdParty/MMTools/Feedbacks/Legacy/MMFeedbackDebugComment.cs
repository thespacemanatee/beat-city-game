...
{
    /// <summary>
    ///     This feedback doesn't do anything by default, it's just meant as a comment, you can store text in it for future
    ///     reference, maybe to remember how you setup a particular MMFeedbacks. Optionnally it can also output that comment to
    ///     the console on Play.
    /// </summary>
    [AddComponentMenu("")]
    [FeedbackHelp(
    ...
    public class MMFeedbackDebugComment : MMFeedback
    {
        ...
        {
            if (!Active || !FeedbackTypeAuthorized || !LogComment) return;
