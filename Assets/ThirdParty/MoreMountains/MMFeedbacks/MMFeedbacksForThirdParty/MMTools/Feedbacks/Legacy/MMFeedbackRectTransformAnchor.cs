...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackRectTransformAnchor : MMFeedbackBase
    {
        ...
        [Tooltip("the curve to animate the min anchor on")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
        ...
        [Tooltip("the value to remap the min anchor curve's 0 on")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
        ...
        [Tooltip("the curve to animate the max anchor on")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
        ...
        [Tooltip("the value to remap the max anchor curve's 0 on")] [MMFEnumCondition("Mode", (int)Modes.OverTime)]
