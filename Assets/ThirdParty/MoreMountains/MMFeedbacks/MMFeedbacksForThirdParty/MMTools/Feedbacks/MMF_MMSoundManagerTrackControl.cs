...
{
    /// <summary>
    ///     This feedback will let you control all sounds playing on a specific track (master, UI, music, sfx), and play,
    ///     pause, mute, unmute, resume, stop, free them all at once. You will need a MMSoundManager in your scene for this to
    ///     work.
    /// </summary>
    [AddComponentMenu("")]
    ...
    public class MMF_MMSoundManagerTrackControl : MMF_Feedback
    {
        ...
        public override string RequiredTargetText => Track + " " + ControlMode;
#endif
    }
}