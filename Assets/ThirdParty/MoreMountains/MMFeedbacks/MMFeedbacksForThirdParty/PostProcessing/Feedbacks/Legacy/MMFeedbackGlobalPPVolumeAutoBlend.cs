...
{
    /// <summary>
    ///     This feedback will let you pilot a Global PostProcessing Volume AutoBlend component. A GPPVAB component is placed
    ///     on a PostProcessing Volume, and will let you control and blend its weight over time on demand.
    /// </summary>
    [AddComponentMenu("")]
    ...
    public class MMFeedbackGlobalPPVolumeAutoBlend : MMFeedback
    {
        ...
        public override float FeedbackDuration
        {
            get
            {
                if (Mode == Modes.Override) return BlendDuration;
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            if (Mode == Modes.Default)
            {
                ...
                else
                {
                    ...
                    if (BlendAction == Actions.BlendBack) TargetAutoBlend.BlendBack();
                }
            }
            else
            {
        ...
        protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1)
        {
            ...
            if (TargetAutoBlend != null) TargetAutoBlend.StopBlending();
        }
    }
}