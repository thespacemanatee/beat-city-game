...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackTMPDilate : MMFeedback
    {
        ...
        public MMTweenType DilateCurve =
            new(new AnimationCurve(new Keyframe(0, 0.5f), new Keyframe(0.3f, 1f), new Keyframe(1, 0.5f)));
        ...
        {
            var intensity = MMTween.Tween(time, 0f, 1f, RemapZero, RemapOne, DilateCurve);
