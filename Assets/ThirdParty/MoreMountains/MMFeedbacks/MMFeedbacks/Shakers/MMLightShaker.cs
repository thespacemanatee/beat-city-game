...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMLightShaker : MMShaker
    {
        ...
        {
            base.Initialization();
            if (BoundLight == null) BoundLight = gameObject.GetComponent<Light>();
        }
        ...
        {
            var newRange = ShakeFloat(RangeCurve, RemapRangeZero, RemapRangeOne, RelativeValues, _initialRange);
            BoundLight.range = newRange;
            var newIntensity = ShakeFloat(IntensityCurve, RemapIntensityZero, RemapIntensityOne, RelativeValues,
                _initialIntensity);
            BoundLight.intensity = newIntensity;
            var newShadowStrength = ShakeFloat(ShadowStrengthCurve, RemapShadowStrengthZero, RemapShadowStrengthOne,
