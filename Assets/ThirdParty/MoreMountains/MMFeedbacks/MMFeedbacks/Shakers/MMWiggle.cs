...
namespace MoreMountains.Feedbacks
{
    ...
    /// <summary>
    ///     Add this class to a GameObject to be able to control its position/rotation/scale individually and periodically,
    ///     allowing it to "wiggle" (or just move however you want on a periodic basis)
    /// </summary>
    ...
    public class MMWiggle : MonoBehaviour
    {
        ...
        {
            internalProperties.newValue = transform.localPosition;
            ...
            ref InternalWiggleProperties internalProperties)
        {
            ...
            {
                var timeSave = properties.LimitedTimeLeft;
        ...
        protected float ApplyFalloff(WiggleProperties properties)
        {
            ...
            if (properties.LimitedTime && properties.LimitedTimeTotal > 0f)
            {
                var curveProgress = (properties.LimitedTimeTotal - properties.LimitedTimeLeft) /
            ...
            WiggleProperties properties)
        {
            ...
            {
                var curveProgress = internalProperties.curveDirection == 1f ? 1f : 0f;
            ...
            {
                var curveProgress = internalProperties.timeSinceLastChange / internalProperties.randomFrequency;
            ...
            ref float pauseDuration, float frequency)
        {
            ...
            if (frequency > 0)
            {
                var curveProgress = timeSinceLastValueChange / frequency;
                ...
                {
                    var curvePercent = properties.SpeedCurve.Evaluate(curveProgress);
