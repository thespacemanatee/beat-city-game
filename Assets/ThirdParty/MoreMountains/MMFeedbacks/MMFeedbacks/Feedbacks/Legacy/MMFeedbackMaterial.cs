...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackMaterial : MMFeedback
    {
        ...
        protected override void CustomInitialization(GameObject owner)
        {
            ...
            if (RendererMaterialIndexes == null) RendererMaterialIndexes = new int[1];
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            var newIndex = DetermineNextIndex();
            ...
            if (InterpolateTransition)
                for (var i = 0; i < RendererMaterialIndexes.Length; i++)
            ...
            int materialIndex)
        {
            ...
            {
                var time = MMFeedbacksHelpers.Remap(GetTime() - _startedAt, 0f, TransitionDuration, 0f, 1f);
                var t = TransitionCurve.Evaluate(time);

                LerpMaterial(originalMaterial, newMaterial, t, materialIndex);
                yield return null;
            }

            var finalt = TransitionCurve.Evaluate(1f);
