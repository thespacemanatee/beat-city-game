...
{
    /// <summary>
    ///     This feedback will trigger a freeze frame event when played, pausing the game for the specified duration (usually
    ///     short, but not necessarily)
    /// </summary>
    [AddComponentMenu("")]
    [FeedbackHelp(
    ...
    public class MMFeedbackFreezeFrame : MMFeedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            if (Time.timeScale < MinimumTimescaleThreshold) return;
