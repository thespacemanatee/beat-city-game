...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackEvents : MMFeedback
    {
        ...
        {
            if (!Active || !FeedbackTypeAuthorized || PlayEvents == null) return;
            PlayEvents.Invoke();
        }
        ...
        {
            if (!Active || !FeedbackTypeAuthorized || StopEvents == null) return;
            StopEvents.Invoke();
        }
        ...
        {
            if (!Active || !FeedbackTypeAuthorized || ResetEvents == null) return;
            base.CustomReset();
            ResetEvents.Invoke();
        }
    }
