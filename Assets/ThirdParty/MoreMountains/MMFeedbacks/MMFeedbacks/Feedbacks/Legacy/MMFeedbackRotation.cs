...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbackRotation : MMFeedback
    {
        ...
        {
            if (!Active || !FeedbackTypeAuthorized || AnimateRotationTarget == null) return;
        ...
        protected virtual IEnumerator RotateToDestination()
        {
            ...
            var destinationAngles = NormalPlayDirection ? DestinationAngles : _initialToDestinationAngles;
            ...
            while (journey >= 0 && journey <= FeedbackDuration && FeedbackDuration > 0)
            {
                ...
                var newRotation = Quaternion.LerpUnclamped(_initialRotation, _destinationRotation, percent);
