...
{
    /// <summary>
    ///     This feedback allows you to trigger a target MMFeedbacks, or any MMFeedbacks on the specified Channel within a
    ///     certain range. You'll need an MMFeedbacksShaker on them.
    /// </summary>
    [AddComponentMenu("")]
    [FeedbackHelp(
    ...
    public class MMF_Feedbacks : MMF_Feedback
    {
        ...
        protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            else if (Mode == Modes.PlayTargetFeedbacks) TargetFeedbacks?.PlayFeedbacks(position, feedbacksIntensity);
        }
