...
namespace MoreMountains.Feedbacks
{
    public class MMMiniObjectPooler : MonoBehaviour
    {
        ...
        {
            if (_objectPool != null) RemovePool(_objectPool);
        }
        ...
        {
            if (_pools == null) _pools = new List<MMMiniObjectPool>(_initialPoolsListCapacity);
        ...
        protected virtual void CreateWaitingPool()
        {
            ...
            var waitingPool = ExistingPool(DetermineObjectPoolName(GameObjectToPool));
        ...
        public virtual void FillObjectPool()
        {
            ...
            for (var i = 0; i < objectsToSpawn; i++) AddOneObjectToThePool();
        }
        ...
        public virtual GameObject GetPooledGameObject()
        {
            ...
            for (var i = 0; i < _pooledGameObjects.Count; i++)
        ...
        protected virtual GameObject AddOneObjectToThePool()
        {
            ...
            if (NestWaitingPool) newGameObject.transform.SetParent(_objectPool.transform);
