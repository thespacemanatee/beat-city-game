...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMF_PlayerEvents
    {
        ...
        public virtual void TriggerOnPlay(MMF_Player source)
        {
            ...
            if (TriggerMMFeedbacksEvents) MMF_PlayerEvent.Trigger(source, MMF_PlayerEvent.EventTypes.Play);
        }
        ...
        public virtual void TriggerOnPause(MMF_Player source)
        {
            ...
            if (TriggerMMFeedbacksEvents) MMF_PlayerEvent.Trigger(source, MMF_PlayerEvent.EventTypes.Pause);
        }
        ...
        public virtual void TriggerOnResume(MMF_Player source)
        {
            ...
            if (TriggerMMFeedbacksEvents) MMF_PlayerEvent.Trigger(source, MMF_PlayerEvent.EventTypes.Resume);
        }
        ...
        public virtual void TriggerOnRevert(MMF_Player source)
        {
            ...
            if (TriggerMMFeedbacksEvents) MMF_PlayerEvent.Trigger(source, MMF_PlayerEvent.EventTypes.Revert);
        }
        ...
        public virtual void TriggerOnComplete(MMF_Player source)
        {
            ...
            if (TriggerMMFeedbacksEvents) MMF_PlayerEvent.Trigger(source, MMF_PlayerEvent.EventTypes.Complete);
        }
    }
}