...
namespace MoreMountains.Tools
{
    ...
    public class MMCinemachineZone2D : MMCinemachineZone
    {
        ...
        protected virtual void CopyCollider()
        {
            ...
            {
                var boxCollider2D = _confinerGameObject.AddComponent<BoxCollider2D>();
            ...
            {
                var circleCollider2D = _confinerGameObject.AddComponent<CircleCollider2D>();
            ...
            {
                var polygonCollider2D = _confinerGameObject.AddComponent<PolygonCollider2D>();
