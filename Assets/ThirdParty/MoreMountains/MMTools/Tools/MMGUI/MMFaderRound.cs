...
namespace MoreMountains.Tools
{
        ...
        MMEventListener<MMFadeOutEvent>, MMEventListener<MMFadeStopEvent>
    {
        ...
        protected virtual void Fade()
        {
            ...
            {
                var newScale = MMTween.Tween(currentTime, _fadeStartedAt, endTime, _initialScale, _currentTargetScale,
                    _currentCurve);
            ...
            bool ignoreTimeScale, Vector3 worldPosition)
        {
            ...
            var newScale = MMTween.Tween(0f, 0f, duration, _initialScale, _currentTargetScale, _currentCurve);
            FaderMask.transform.localScale = newScale * Vector3.one;
        }
    }
}