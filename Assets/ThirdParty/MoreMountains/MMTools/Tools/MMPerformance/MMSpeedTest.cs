...
namespace MoreMountains.Tools
{
    ...
    public static class MMSpeedTest
    {
        ...
        public static void StartTest(string testID)
        {
            ...
            var item = new MMSpeedTestItem(testID);
        ...
        public static void EndTest(string testID)
        {
            ...
            var elapsedTime = _speedTests[testID].Timer.ElapsedMilliseconds / 1000f;
            _speedTests.Remove(testID);

            Debug.Log("<color=red>MMSpeedTest</color> [Test " + testID + "] test duration : " + elapsedTime + "s");
        }
    }
}