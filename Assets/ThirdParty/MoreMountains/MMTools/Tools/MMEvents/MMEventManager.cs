...
namespace MoreMountains.Tools
{
    ...
    {
        private static readonly Dictionary<Type, List<MMEventListenerBase>> _subscribersList;
        ...
        public static void TriggerEvent<MMEvent>(MMEvent newEvent) where MMEvent : struct
        {
            ...
            for (var i = 0; i < list.Count; i++) (list[i] as MMEventListener<MMEvent>).OnMMEvent(newEvent);
        }
