...
namespace MoreMountains.Tools
{
	...
	///     Load : TestObject = (YourObjectClass)MMSaveLoadManager.Load(typeof(YourObjectClass), FileName + SaveFileExtension,
	///     FolderName);
	...
	///     You can also specify what IMMSaveLoadManagerMethod the system should use. By default it's binary but you can also
	///     pick binary encrypted, json, or json encrypted
	...
	public static class MMSaveLoadManager
    {
        ...
        {
            var savePath = DetermineSavePath(foldername);
            var saveFileName = DetermineSaveFileName(fileName);
        ...
        {
            var savePath = DetermineSavePath(foldername);
            var saveFileName = savePath + DetermineSaveFileName(fileName);
