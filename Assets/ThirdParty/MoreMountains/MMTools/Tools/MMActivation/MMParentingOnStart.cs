...
{
    /// <summary>
    ///     This component lets you parent the transform you put it on to any target parent (or to the root if none is set), on
    ///     Awake, Start or anytime you call its Parent() method
    /// </summary>
