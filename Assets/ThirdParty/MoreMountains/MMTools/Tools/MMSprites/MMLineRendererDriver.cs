...
{
    /// <summary>
    ///     This component, added to a line renderer, will let you fill a list of transforms, and bind their positions to the
    ///     linerenderer's positions.
    /// </summary>
    ...
    public class MMLineRendererDriver : MonoBehaviour
    {
        ...
        public virtual void BindPositionsToTargets()
        {
            ...
            for (var i = 0; i < Targets.Count; i++) _lineRenderer.SetPosition(i, Targets[i].position);
        }
