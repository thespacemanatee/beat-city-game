...
namespace MoreMountains.Tools
{
    ...
    public struct MMSoundManagerPlayOptions
    {
        ...
        ///     Here we initialize a new local options set, override its loop, location and track settings, and call a play event
        ///     using it
        /// </summary>
        public static MMSoundManagerPlayOptions Default
        {
            get
            {
                var defaultOptions = new MMSoundManagerPlayOptions();
