...
{
	/// <summary>
	///     This persistent singleton handles the inputs and sends commands to the player in the MMControls demo, its sole
	///     purpose is to output debug logs of the various interactions with the demo's inputs
	/// </summary>
