...
namespace MoreMountains.Tools
{
    ...
    public class MMTouchJoystick : MonoBehaviour, IDragHandler, IEndDragHandler
    {
        ...
        protected virtual void RotateIndicator()
        {
            ...
            var angle = Mathf.Atan2(_joystickValue.y, _joystickValue.x) * Mathf.Rad2Deg;
        ...
        /// <summary>
        ///     We compute the axis value from the interval between neutral position, current stick position (vectorPosition) and
        ///     max range
        /// </summary>
