...
namespace MoreMountains.Tools
{
    ...
    /// <summary>
    ///     An event usually triggered when a swipe happens. It contains the swipe "base" direction, and detailed information
    ///     if needed (angle, length, origin and destination
    /// </summary>
    ...
    /// <summary>
    ///     Add a swipe manager to your scene, and it'll trigger MMSwipeEvents everytime a swipe happens. From its inspector
    ///     you can determine the minimal length of a swipe. Shorter swipes will be ignored
    /// </summary>
        ...
        IPointerEnterHandler
    {
        ...
        {
            var duration = _swipeEndedAt - _swipeStartedAt;
            var swipeEvent = new MMSwipeEvent(_swipeDirection, _angle, _length, _firstTouchPosition, _destination,
                duration);
