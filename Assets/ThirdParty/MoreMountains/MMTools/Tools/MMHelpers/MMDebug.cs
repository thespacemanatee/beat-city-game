...
namespace MoreMountains.Tools
{
	...
	public static class MMDebug
    {
        ...
        public static void DebugLogCommand(string command)
        {
            ...
            var commandFirst = MMString.UppercaseFirst(splitCommand[0]);
            ...
            if (splitCommand.Length > 1)
            {
                ...
                var argumentAttribute = commandInfo.GetCustomAttributes<MMDebugLogCommandArgumentCountAttribute>(true)
                    .FirstOrDefault();
        ...
        {
            var item = new DebugLogItem(command, color, Time.frameCount, Time.time, 3, true);
            LogHistory.Add(item);
            ...
            bool displayFrameCount = true)
        {
            ...
            var callerObjectName = new StackTrace().GetFrame(1).GetMethod().ReflectedType.Name;
            ...
            var item = new DebugLogItem(message, color, Time.frameCount, Time.time, timePrecision, displayFrameCount);
        ...
        public static void InstantiateOnScreenConsole(int fontSize = 25)
        {
            ...
            if (_console == null)
            {
                ...
                var loaded = Object.Instantiate(Resources.Load(_debugConsolePrefabPath) as GameObject);
