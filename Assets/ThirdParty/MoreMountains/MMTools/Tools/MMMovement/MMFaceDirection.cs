...
{
    /// <summary>
    ///     Use this script to have a Transform automatically face a certain direction, whether its own movement direction, or
    ///     a specific target Transform
    /// </summary>
    public class MMFaceDirection : MonoBehaviour
    {
        ...
        [Header("Axis Locks")] public bool LockXAxis;
