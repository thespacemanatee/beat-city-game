...
namespace MoreMountains.Tools
{
    ...
    public class MMDebugMenu : MonoBehaviour
    {
        ...
        public virtual void FillMenu(bool triggerEvents = false)
        {
            ...
            foreach (Transform child in Contents.transform) Destroy(child.gameObject);
            ...
            foreach (var tab in Data.Tabs)
            {
                ...
                var tabBarTab = Instantiate(Data.TabPrefab);
                ...
                // create tab contents
                var contents = Instantiate(Data.TabContentsPrefab);
            ...
            if (Data.DisplayDebugTab)
            {
                ...
                var debugTab = Instantiate(Data.DebugTabPrefab);
                ...
                var debugTabContents = debugTab.GetComponent<MMDebugMenuTabContents>();
                debugTabContents.Index = tabCounter;
                TabManager.TabsContents.Add(debugTabContents);
                var rectTransform = debugTabContents.GetComponent<RectTransform>();
                rectTransform.MMSetLeft(0f);
                rectTransform.MMSetRight(0f);
                rectTransform.MMSetTop(0f);
                rectTransform.MMSetBottom(0f);
            ...
            // fill with spacers 
            var spacerCount = Data.MaxTabs - tabCounter;
            for (var i = 0; i < spacerCount; i++)
            {
                var spacer = Instantiate(Data.TabSpacerPrefab);
        ...
        protected virtual void FillTab(MMDebugMenuTabContents tab, int index, bool triggerEvents = false)
        {
            ...
            foreach (var item in Data.Tabs[index].MenuItems)
            {
                ...
                switch (item.Type)
                {
                    ...
                    case MMDebugMenuItem.MMDebugMenuItemTypes.Checkbox:
                        var checkbox = Instantiate(Data.CheckboxPrefab);
                    ...
                    case MMDebugMenuItem.MMDebugMenuItemTypes.Slider:
                        var slider = Instantiate(Data.SliderPrefab);
                    ...
                    case MMDebugMenuItem.MMDebugMenuItemTypes.Spacer:
                        var spacerPrefab = item.SpacerType == MMDebugMenuItem.MMDebugMenuItemSpacerTypes.Small
                    ...
                    case MMDebugMenuItem.MMDebugMenuItemTypes.Title:
                        var title = Instantiate(Data.TitlePrefab);
                    ...
                    case MMDebugMenuItem.MMDebugMenuItemTypes.Choices:
                        ...
                        var choices = Instantiate(choicesPrefab);
                        ...
                        foreach (var entry in choices.Choices)
                            if (entry != null)
                    ...
                    case MMDebugMenuItem.MMDebugMenuItemTypes.Value:
                        var value = Instantiate(Data.ValuePrefab);
            ...
            var finalSpacer = Instantiate(Data.SpacerBigPrefab);
