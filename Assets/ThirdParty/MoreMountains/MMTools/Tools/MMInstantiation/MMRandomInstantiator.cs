...
{
    /// <summary>
    ///     Add this class to an empty object, bind a few prefabs into its RandomPool slots, and it'll instantiate one of them
    ///     at its position/rotation on Start or Awake
    ///     You can also call its InstantiateRandomObject method at any time, and it'll instantiate another random object on
    ///     demand,
    ...
    public class MMRandomInstantiator : MonoBehaviour
    {
        ...
        public virtual void InstantiateRandomObject()
        {
            ...
            if (ParentInstantiatedToThisObject) _instantiatedGameObject.transform.SetParent(transform);
        }
    }
}