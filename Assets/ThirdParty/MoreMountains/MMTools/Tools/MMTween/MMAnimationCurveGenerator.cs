...
namespace MoreMountains.Tools
{
    ...
    ///     This asset will include curves (anti or not) from the MMTween library, to use anywhere animation curves are
    ///     required
    /// </summary>
    public class MMAnimationCurveGenerator : MonoBehaviour
    {
        ...
        public virtual void GenerateAnimationCurvesAsset()
        {
            ...
            var curveAsset = ScriptableObject.CreateInstance(_scriptableObjectType);
            ...
            int curveResolution, bool anti)
        {
            ...
            for (var j = 0; j < curveResolution; j++) animationCurve.SmoothTangents(j, 0f);
