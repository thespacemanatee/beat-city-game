...
namespace MoreMountains.Tools
{
    ...
    ///     I recommend reading this blog post if you're interested in the subject :
    ...
    public class MMTween : MonoBehaviour
    {
        ...
        {
            var turningRate = Tween(currentTime, initialTime, endTime, 0f, 1f, curve);
            ...
            MMTweenCurve curve, bool ignoreTimescale = false)
        {
            ...
            var initialRotationPosition = targetTransform.transform.position;
            var initialRotationRotation = targetTransform.transform.rotation;
            ...
            {
                var newAngle = Tween(timeSpent, 0f, duration, 0f, angle, curve);
