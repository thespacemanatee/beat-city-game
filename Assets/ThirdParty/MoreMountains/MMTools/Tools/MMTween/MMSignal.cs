...
{
    /// <summary>
    ///     This class lets you output the value corresponding to one of the basic signal types it contains. Useful to draw
    ///     basic signal curves.
    /// </summary>
    public class MMSignal
    {
            ...
            float backAndForthTippingPoint = 0.5f)
        {
            ...
            var returnValue = amplitude * value + offset;
