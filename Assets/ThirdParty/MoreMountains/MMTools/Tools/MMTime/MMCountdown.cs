...
namespace MoreMountains.Tools
{
    ...
    public class MMCountdown : MonoBehaviour
    {
        ...
        protected virtual void Initialization()
        {
            ...
            foreach (var floor in Floors) floor.LastChangedAt = CountdownFrom;
        }
        ...
        protected virtual void CheckForEnd()
        {
            ...
            var endReached = Direction == MMCountdownDirections.Ascending
        ...
        /// <summary>
        ///     Every frame, checks if we've reached one of the defined floors, and triggers the corresponding events if that's the
        ///     case
        /// </summary>
