...
namespace MoreMountains.Tools
{
    ...
    /// <summary>
    ///     This class lets you create moving filters, very much like the old gelatin camera filters, that will move to connect
    ///     to your camera
    ...
    public class MMPostProcessingMovingFilter : MonoBehaviour
    {
        ...
        {
            if (_newPosition != transform.localPosition) transform.localPosition = _newPosition;

            var originY = Active ? _initialPosition.y + FilterOffset.y : _initialPosition.y + FilterOffset.x;
            var targetY = Active ? _initialPosition.y + FilterOffset.x : _initialPosition.y + FilterOffset.y;
            var currentTime = TimeScale == TimeScales.Unscaled ? Time.unscaledTime : Time.time;
