        ...
        protected virtual void Rotation()
        {
            ...
            if (Mode == Modes.Touch && Input.touchCount > 0)
            {
                if (Input.touches[0].phase == TouchPhase.Moved && Input.touchCount == 1)
                {
                    ...
                    var swipeSpeed = Input.touches[0].deltaPosition.magnitude / Input.touches[0].deltaTime;
        ...
        protected virtual void Zoom()
        {
            ...
            if (Mode == Modes.Touch && Input.touchCount > 0)
            {
                if (Input.touchCount == 2)
                {
                    ...
                    var previousTouchDeltaMagnitude =
                        (firstTouchPreviousPosition - secondTouchPreviousPosition).magnitude;
                    var thisTouchDeltaMagnitude = (firstTouch.position - secondTouch.position).magnitude;
                    var deltaMagnitudeDifference = previousTouchDeltaMagnitude - thisTouchDeltaMagnitude;
            ...
            else if (Mode == Modes.Mouse)
            {
                ...
                var deltaMagnitudeDifference = _scrollWheelAmount;
