...
{
	/// <summary>
	///     This achievement system supports 2 types of achievements : simple (do something > get achievement), and progress
	///     based (jump X times, kill X enemies, etc).
	/// </summary>
    ...
    public class MMAchievement
    {
        ...
        /// <summary>
        ///     Unlocks the achievement, asks for a save of the current achievements, and triggers an MMAchievementUnlockedEvent
