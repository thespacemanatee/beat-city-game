...
namespace MoreMountains.Tools
{
    ...
    public class ShaderController : MMMonoBehaviour
    {
        ...
        public virtual void Initialization()
        {
            ...
            if (TargetType != TargetTypes.Renderer) UseMaterialPropertyBlocks = false;
            ...
            _shaking = false;
            if (ControlMode == ControlModes.OneTime) enabled = false;
        }
        ...
        protected virtual void UpdateValue()
        {
                ...
                GetTime() - _startedTimestamp > ToDestinationDuration)
            {
                ...
                SetValue(CurrentValue);
                if (DisableAfterToDestination) enabled = false;
                return;
            }
        ...
        protected virtual void SetValue(float newValue)
        {
            ...
            switch (PropertyType)
            {
                case PropertyTypes.Bool:
                    ...
                    var newBool = Mathf.RoundToInt(newValue);
                ...
                case PropertyTypes.Int:
                    var newInt = Mathf.RoundToInt(newValue);
                    if (UseMaterialPropertyBlocks)
                    {
                        TargetRenderer.GetPropertyBlock(_propertyBlock);
