...
namespace MoreMountains.Tools
{
    ...
    public class AITransitionPropertyInspector : PropertyDrawer
    {
        ...
        /// <summary>
        ///     Draws a Transition inspector, a transition is one or more action(s), one or more decision(s) and associated
        ///     true/false states
        /// </summary>
        ...
        {
            var thisDecision = prop.objectReferenceValue as AIDecision;
            ...
            {
                var name = string.IsNullOrEmpty(decision.Label) ? decision.GetType().Name : decision.Label;
                options[i] = i + " - " + name;
