...
namespace MoreMountains.Tools
{
    ...
    public class MMAutoRotateEditor : Editor
    {
        ...
        private static void DrawHandles(MMAutoRotate autoRotate, GizmoType gizmoType)
        {
            ...
            var newRotation = Quaternion.AngleAxis(1f, myTarget._worldRotationAxis);
            var origin = myTarget._orbitCenter + newRotation * myTarget._radius;
