...
namespace MoreMountains.InventoryEngine
{
	...
	public class ChangeLevel : MonoBehaviour
    {
	    ...
	    /// </summary>
	    [MMInformation(
            "This demo component, when added to a BoxCollider2D, will change the scene to the one specified in the field below when the character enters the collider.",
