...
namespace MoreMountains.InventoryEngine
{
	...
	public class DemoCharacterInputManager : MonoBehaviour, MMEventListener<MMInventoryEvent>
    {
        ...
        [MMInformation(
            "This component is a very simple input manager that handles the demo character's input and makes it move. If you remove it from the scene your character won't move anymore.",
        ...
        {
            if (inventoryEvent.InventoryEventType == MMInventoryEventType.InventoryOpens) _pause = true;
            if (inventoryEvent.InventoryEventType == MMInventoryEventType.InventoryCloses) _pause = false;
        }
