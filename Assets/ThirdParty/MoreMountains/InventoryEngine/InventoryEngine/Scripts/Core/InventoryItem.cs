...
namespace MoreMountains.InventoryEngine
{
    ...
    public class InventoryItem : ScriptableObject
    {
        ...
        [MMCondition("ForceSlotIndex", true)] public int TargetIndex;
        ...
        [MMCondition("Usable", true)] public bool Consumable = true;

        /// if this item is consumable, determines how many will be consumed per use (usually one)
        [MMCondition("Consumable", true)] public int ConsumeQuantity = 1;
        ...
        [MMInformation("The name of the item as you want it to appear in the display panel",
            MMInformationAttribute.InformationType.Info, false)]
        public string ItemName;

        [TextArea]
        [MMInformation("The Short and 'long' descriptions will be used to display in the InventoryDetails panel.",
            MMInformationAttribute.InformationType.Info, false)]
        ...
        [MMInformation("The image that will be displayed inside InventoryDisplay panels and InventoryDetails.",
            MMInformationAttribute.InformationType.Info, false)]
        public Sprite Icon;
        ...
        [Header("Equippable")]
        [MMInformation(
            "If this item is equippable, you can set here its target inventory name (for example ArmorInventory). Of course you'll need an inventory with a matching name in your scene. You can also specify a sound to play when this item is equipped. If you don't, a default sound will be played.",
            MMInformationAttribute.InformationType.Info, false)]
        ...
        [Header("Sounds")]
        [MMInformation("Here you can override the default sounds for move and drop events.",
            MMInformationAttribute.InformationType.Info, false)]
        ...
        protected Inventory _targetEquipmentInventory;

        protected Inventory _targetInventory;

        /// whether or not this object can be used
        public virtual bool IsUsable => Usable;
        ...
        {
            if (TargetEquipmentInventoryName == null) return null;
        ...
        /// </summary>
        public virtual bool Pick(string playerID)
        {
            return true;
        }
        ...
        /// </summary>
        public virtual bool Use(string playerID)
        {
            return true;
        }
        ...
        /// </summary>
        public virtual bool Equip(string playerID)
        {
            return true;
        }
        ...
        /// </summary>
        public virtual bool UnEquip(string playerID)
        {
            return true;
        }
        ...
        /// </summary>
        public virtual bool Drop(string playerID)
        {
            return true;
        }
    }
