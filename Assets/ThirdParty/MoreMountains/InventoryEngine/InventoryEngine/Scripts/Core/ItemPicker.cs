...
namespace MoreMountains.InventoryEngine
{
	...
	public class ItemPicker : MonoBehaviour
    {
        ...
        [MMReadOnly] public int RemainingQuantity = 1;
        ...
        public virtual void OnTriggerEnter(Collider collider)
        {
            ...
            var identifier = collider.GetComponent<InventoryCharacterIdentifier>();
            if (identifier != null) playerID = identifier.PlayerID;
        ...
        public virtual void Pick(string targetInventoryName, string playerID = "Player1")
        {
            ...
            {
                MMInventoryEvent.Trigger(MMInventoryEventType.Pick, null, Item.TargetInventoryName, Item,
                    _pickedQuantity, 0, playerID);
            }
        ...
        protected virtual void DisableObjectIfNeeded()
        {
            ...
            if (DisableObjectWhenDepleted && RemainingQuantity <= 0) gameObject.SetActive(false);
        }
        ...
        protected virtual void DetermineMaxQuantity()
        {
            ...
            if (RemainingQuantity < _pickedQuantity) _pickedQuantity = RemainingQuantity;
        }
        ...
        public virtual bool Pickable()
        {
            if (!PickableIfInventoryIsFull && _targetInventory.NumberOfFreeSlots == 0)
            {
                ...
                var list = _targetInventory.InventoryContains(Item.ItemID);
                if (list.Count > 0)
