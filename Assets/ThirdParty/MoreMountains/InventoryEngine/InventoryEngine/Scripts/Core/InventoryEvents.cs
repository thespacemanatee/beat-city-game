...
namespace MoreMountains.InventoryEngine
{
	...
	/// <summary>
	///     Inventory events are used throughout the Inventory Engine to let other interested classes know that something
	///     happened to an inventory.
	/// </summary>
	public struct MMInventoryEvent
    {
        ...
        public MMInventoryEvent(MMInventoryEventType eventType, InventorySlot slot, string targetInventoryName,
            InventoryItem eventItem, int quantity, int index, string playerID)
        {
        ...
        private static MMInventoryEvent e;

        public static void Trigger(MMInventoryEventType eventType, InventorySlot slot, string targetInventoryName,
            InventoryItem eventItem, int quantity, int index, string playerID)
        {
