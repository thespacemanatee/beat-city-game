...
namespace MoreMountains.InventoryEngine
{
	...
	public class InventoryDetails : MonoBehaviour, MMEventListener<MMInventoryEvent>
    {
        ...
        [MMInformation(
            "Specify here the name of the inventory whose content's details you want to display in this Details panel. You can also decide to make it global. If you do so, it'll display the details of all items, regardless of their inventory.",
        ...
        [Header("Components")]
        [MMInformation("Here you need to bind the panel components.", MMInformationAttribute.InformationType.Info,
            false)]
        ...
        public virtual void OnMMEvent(MMInventoryEvent inventoryEvent)
        {
            ...
            if (!Global && inventoryEvent.TargetInventoryName != TargetInventoryName) return;
        ...
        public virtual void DisplayDetails(InventoryItem item)
        {
            if (InventoryItem.IsNull(item))
            {
                ...
                if (!HideOnEmptySlot) StartCoroutine(FillDetailFieldsWithDefaults(0));
            }
            else
            {
