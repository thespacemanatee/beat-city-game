...
namespace MoreMountains.TopDownEngine
{
    ...
    public class AutoRespawn : MonoBehaviour, Respawnable
    {
        ...
        public bool RepositionToInitOnPlayerRespawn;
        ...
        public bool DisableAllComponentsOnKill;
        ...
        protected bool _reviving;
        protected float _timeOfDeath;
        ...
        protected virtual void Start()
        {
            ...
            _otherComponents = gameObject.GetComponents<MonoBehaviour>();
            _collider2D = gameObject.GetComponent<Collider2D>();
            _renderer = gameObject.GetComponent<Renderer>();
            _health = gameObject.GetComponent<Health>();
            _aiBrain = gameObject.GetComponent<AIBrain>();
        ...
        {
            if (RepositionToInitOnPlayerRespawn) transform.position = _initialPosition;
        ...
        {
            if (RespawnSfx != null)
                MMSoundManagerSoundPlayEvent.Trigger(RespawnSfx, MMSoundManager.MMSoundManagerTracks.Sfx,
                    transform.position);
        }
    }
}