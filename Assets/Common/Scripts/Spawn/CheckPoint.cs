...
namespace MoreMountains.TopDownEngine
{
	...
	public struct CheckPointEvent
    {
        ...
        private static CheckPointEvent e;
    ...
    public class CheckPoint : MonoBehaviour
    {
        ...
        protected virtual void OnDrawGizmos()
        {
            ...
            if (LevelManager.Instance.Checkpoints == null) return;

            if (LevelManager.Instance.Checkpoints.Count == 0) return;
            ...
            for (var i = 0; i < LevelManager.Instance.Checkpoints.Count; i++)
                ...
                if (i + 1 < LevelManager.Instance.Checkpoints.Count)
                {
                    ...
                    Gizmos.DrawLine(LevelManager.Instance.Checkpoints[i].transform.position,
        ...
        public virtual void SpawnPlayer(Character player)
        {
            ...
            foreach (var listener in _listeners) listener.OnPlayerRespawn(this, player);
        }
