...
namespace MoreMountains.TopDownEngine
{
    ...
    public class GUIManager : MMSingleton<GUIManager>
    {
        ...
        [Tooltip("the health bars to update")] public MMProgressBar[] HealthBars;

        /// the dash bars to update
        [Tooltip("the dash bars to update")] public MMRadialProgressBar[] DashBars;
        ...
        /// the death screen
        [Tooltip("the death screen")] public GameObject DeathScreen;

        /// The mobile buttons
        [Tooltip("The mobile buttons")] public CanvasGroup Buttons;

        /// The mobile arrows
        [Tooltip("The mobile arrows")] public CanvasGroup Arrows;
        ...
        /// the points counter
        [Tooltip("the points counter")] public Text PointsText;
        ...
        public virtual void SetDashBar(bool state, string playerID)
        {
            ...
            foreach (var jetpackBar in DashBars)
                if (jetpackBar != null)
        ...
        {
            if (PointsText != null) PointsText.text = GameManager.Instance.Points.ToString(PointsTextPattern);
        }
        ...
        public virtual void UpdateDashBars(float currentFuel, float minFuel, float maxFuel, string playerID)
        {
            ...
            foreach (var dashbar in DashBars)
            {
        ...
        public virtual void UpdateAmmoDisplays(bool magazineBased, int totalAmmo, int maxAmmo, int ammoInMagazine,
            int magazineSize, string playerID, int ammoDisplayID, bool displayTotal)
        {
            if (AmmoDisplays == null) return;
            ...
            foreach (var ammoDisplay in AmmoDisplays)
            {
                ...
                if (ammoDisplay.PlayerID == playerID && ammoDisplayID == ammoDisplay.AmmoDisplayID)
                    ammoDisplay.UpdateAmmoDisplays(magazineBased, totalAmmo, maxAmmo, ammoInMagazine, magazineSize,
                        displayTotal);
            }
        }
    }
