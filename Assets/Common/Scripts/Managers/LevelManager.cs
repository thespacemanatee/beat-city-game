...
namespace MoreMountains.TopDownEngine
{
    ...
    public class LevelManager : MMSingleton<LevelManager>, MMEventListener<TopDownEngineEvent>
    {
        ...
        public MMTweenType FadeCurve = new(MMTween.MMTweenCurve.EaseInOutCubic);
        ...
        public Bounds LevelBounds => _collider == null ? new Bounds() : _collider.bounds;
        ...
        protected virtual void Start()
        {
            ...
            if (UseLevelBounds) MMCameraEvent.Trigger(MMCameraEventTypes.SetConfiner, null, BoundsCollider);
        ...
        protected virtual void InstantiatePlayableCharacters()
        {
            ...
            {
                var newPlayer = Instantiate(GameManager.Instance.StoredCharacter, _initialSpawnPointPosition,
                    Quaternion.identity);
        ...
        protected virtual void CheckpointAssignment()
        {
            ...
            var listeners = FindObjectsOfType<MonoBehaviour>().OfType<Respawnable>();
        ...
        {
            if (PlayerPrefabs.Count() <= 0 && SceneCharacters.Count <= 0) yield break;
        ...
        {
            foreach (var player in Players) player.Freeze();
        }
        ...
        {
            foreach (var player in Players) player.UnFreeze();
        }

        /// <summary>
        ///     Sets the current checkpoint with the one set in parameter. This checkpoint will be saved and used should the player
        ///     die.
        /// </summary>
