...
{
	/// <summary>
	///     Add this component to an object in your scene to have it act like a chest. You'll need a key operated zone to open
	///     it, and item picker(s) on it to fill its contents
	/// </summary>
    ...
    public class InventoryEngineChest : MonoBehaviour
    {
        ...
        {
            if (_itemPickerList.Length == 0) return;
            foreach (var picker in _itemPickerList) picker.Pick();
        }
    }
}