...
namespace MoreMountains.TopDownEngine
{
	...
	public struct PickableItemEvent
    {
        ...
        private static PickableItemEvent e;
	...
	public class PickableItem : MonoBehaviour
    {
        ...
        public bool DisableColliderOnPick;
        ...
        /// if this is set to true, the object will be disabled when picked
        [Tooltip("if this is set to true, the object will be disabled when picked")]
        public bool DisableModelOnPick;
        ...
        public bool DisableTargetObjectOnPick;
        ...
        [MMCondition("DisableModelOnPick", true)] [Tooltip("the visual representation of this picker")]
        ...
        public virtual void PickItem(GameObject picker)
        {
            if (CheckIfPickable())
            {
                ...
                if (DisableModelOnPick && Model != null) Model.gameObject.SetActive(false);
