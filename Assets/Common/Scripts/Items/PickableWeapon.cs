...
namespace MoreMountains.TopDownEngine
{
    ...
    public class PickableWeapon : PickableItem
    {
        ...
        {
            var character = _collidingObject.gameObject.MMGetComponentNoAlloc<Character>();
        ...
        protected override bool CheckIfPickable()
        {
            ...
            if (_character == null || _character.FindAbility<CharacterHandleWeapon>() == null) return false;
            ...
            var handleWeapons = _character.GetComponentsInChildren<CharacterHandleWeapon>();
            ...
            if (_characterHandleWeapon == null) return false;
            return true;
        }
    }
}