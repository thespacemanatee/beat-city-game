...
namespace MoreMountains.TopDownEngine
{
        ...
        MMEventListener<MMInventoryEvent>
    {
        ...
        {
            if (checkPointEvent.Order > 0) MMAchievementManager.UnlockAchievement("SteppingStone");
        }
	    ...
	    public virtual void OnMMEvent(MMInventoryEvent inventoryEvent)
        {
            if (inventoryEvent.InventoryEventType == MMInventoryEventType.Pick)
            {
                ...
                if (inventoryEvent.EventItem.ItemID == "KoalaHealth") MMAchievementManager.UnlockAchievement("Medic");
            }
        }
