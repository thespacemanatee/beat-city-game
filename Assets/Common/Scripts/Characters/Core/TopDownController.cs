...
namespace MoreMountains.TopDownEngine
{
	...
	public class TopDownController : MonoBehaviour
    {
        ...
        [MMReadOnly] [Tooltip("the current speed of the character")]
        public Vector3 Speed;

        /// the current velocity
        [MMReadOnly] [Tooltip("the current velocity in units/second")]
        public Vector3 Velocity;

        /// the velocity of the character last frame
        [MMReadOnly] [Tooltip("the velocity of the character last frame")]
        public Vector3 VelocityLastFrame;

        /// the current acceleration
        [MMReadOnly] [Tooltip("the current acceleration")]
        public Vector3 Acceleration;

        /// whether or not the character is grounded
        [MMReadOnly] [Tooltip("whether or not the character is grounded")]
        public bool Grounded;

        /// whether or not the character got grounded this frame
        [MMReadOnly] [Tooltip("whether or not the character got grounded this frame")]
        public bool JustGotGrounded;

        /// the current movement of the character
        [MMReadOnly] [Tooltip("the current movement of the character")]
        public Vector3 CurrentMovement;

        /// the direction the character is going in
        [MMReadOnly] [Tooltip("the direction the character is going in")]
        public Vector3 CurrentDirection;

        /// the current friction
        [MMReadOnly] [Tooltip("the current friction")]
        public float Friction;

        /// the current added force, to be added to the character's movement
        [MMReadOnly] [Tooltip("the current added force, to be added to the character's movement")]
        public Vector3 AddedForce;

        /// whether or not the character is in free movement mode or not
        [MMReadOnly] [Tooltip("whether or not the character is in free movement mode or not")]
        ...
        {
            if (Time.deltaTime != 0f) Speed = (transform.position - _positionLastFrame) / Time.deltaTime;
