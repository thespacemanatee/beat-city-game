...
namespace MoreMountains.TopDownEngine
{
	...
	/// <summary>
	///     MMCharacterEvents are used in addition to the events triggered by the character's state machine, to signal stuff
	///     happening that is not necessarily linked to a change of state
	/// </summary>
	public struct MMCharacterEvent
    {
        ...
        private static MMCharacterEvent e;
    ...
    public enum MMLifeCycleEventTypes
    {
        Death,
        Revive
    }
    ...
    public struct MMLifeCycleEvent
    {
        ...
        private static MMLifeCycleEvent e;
    ...
    public struct MMDamageTakenEvent
    {
        ...
        public MMDamageTakenEvent(Character affectedCharacter, GameObject instigator, float currentHealth,
            float damageCaused, float previousHealth)
        {
        ...
        private static MMDamageTakenEvent e;

        public static void Trigger(Character affectedCharacter, GameObject instigator, float currentHealth,
            float damageCaused, float previousHealth)
        {
