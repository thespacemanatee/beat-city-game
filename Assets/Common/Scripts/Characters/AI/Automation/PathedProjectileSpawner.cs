...
namespace MoreMountains.TopDownEngine
{
    ...
    {
        [MMInformation("A GameObject with this component will spawn projectiles at the specified fire rate.",
        ...
        [Tooltip("the projectiles to spawn")] public PathedProjectile Projectile;
