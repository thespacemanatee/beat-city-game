...
namespace MoreMountains.TopDownEngine
{
    ...
    public class AIActionAimWeaponAtMovement : AIAction
    {
        ...
        public override void Initialization()
        {
            ...
            _aiActionShoot2D = gameObject.GetComponent<AIActionShoot2D>();
            _aiActionShoot3D = gameObject.GetComponent<AIActionShoot3D>();
        ...
        public override void PerformAction()
        {
            if (!Shooting())
            {
                ...
                if (_weaponAim == null) GrabWeaponAim();
        ...
        {
            if (_aiActionShoot2D != null) return _aiActionShoot2D.ActionInProgress;
            if (_aiActionShoot3D != null) return _aiActionShoot3D.ActionInProgress;
            return false;
        }
