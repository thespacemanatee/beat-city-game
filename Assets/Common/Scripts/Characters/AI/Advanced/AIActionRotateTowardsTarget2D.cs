...
{
    /// <summary>
    ///     This AI Action will let an agent with a CharacterRotation2D ability (set to ForcedRotation:true) rotate to face its
    ///     target
    /// </summary>
    ...
    public class AIActionRotateTowardsTarget2D : AIAction
    {
        ...
        {
            _characterRotation2D = gameObject.GetComponentInParent<Character>()?.FindAbility<CharacterRotation2D>();
        }
        ...
        protected virtual void Rotate()
        {
            ...
            _characterRotation2D.ForcedRotationDirection = (_targetPosition - transform.position).normalized;
        }
    }
}