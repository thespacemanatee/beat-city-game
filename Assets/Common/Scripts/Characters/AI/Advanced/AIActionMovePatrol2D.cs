...
namespace MoreMountains.TopDownEngine
{
    ...
    public class AIActionMovePatrol2D : AIAction
    {
        ...
        protected virtual void CheckForObstacles()
        {
            ...
            var raycast = MMDebug.RayCast(_controller.ColliderCenter, _direction, 1f, ObstaclesLayerMask, MMColors.Gold,
                true);
        ...
        protected virtual void OnRevive()
        {
            ...
            if (_orientation2D != null) _direction = _orientation2D.IsFacingRight ? Vector2.right : Vector2.left;
