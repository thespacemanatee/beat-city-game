...
namespace MoreMountains.TopDownEngine
{
    ...
    public class AIDecisionDetectTargetRadius2D : AIDecision
    {
        ...
        protected virtual bool DetectTarget()
        {
            ...
            var numberOfResults = Physics2D.OverlapCircleNonAlloc(_raycastOrigin, Radius, _results, TargetLayer);
            ...
            for (var i = 0; i < min; i++)
            {
                ...
                if (!CanTargetSelf)
                    if (_results[i].gameObject == _brain.Owner || _results[i].transform.IsChildOf(transform))
                        continue;
            ...
            {
                _boxcastDirection = t.gameObject.MMGetComponentNoAlloc<Collider2D>().bounds.center -
