...
{
    /// <summary>
    ///     This decision returns true if there's no obstacle in a straight line between the agent and the brain's target, in
    ///     3D
    /// </summary>
    ...
    public class AIDecisionLineOfSightToTarget3D : AIDecision
    {
        ...
        public Vector3 LineOfSightOffset = new(0, 0, 0);
        ...
        protected virtual bool CheckLineOfSight()
        {
            ...
            var hit = MMDebug.Raycast3D(_raycastOrigin, _directionToTarget.normalized, _directionToTarget.magnitude,
