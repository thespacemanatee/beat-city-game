...
namespace MoreMountains.TopDownEngine
{
    ...
    public class AIActionInvertPatrolDirection : AIAction
    {
        ...
        {
            if (_movePatrol2D == null) _movePatrol2D = gameObject.GetComponentInParent<AIActionMovePatrol2D>();
            if (_movePatrol3D == null) _movePatrol3D = gameObject.GetComponentInParent<AIActionMovePatrol3D>();
        }
