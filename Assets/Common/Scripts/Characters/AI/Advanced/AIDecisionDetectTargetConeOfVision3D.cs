...
{
    /// <summary>
    ///     This Decision will return true if its MMConeOfVision has detected at least one target, and will set it as the
    ///     Brain's target
    /// </summary>
    ...
    public class AIDecisionDetectTargetConeOfVision3D : AIDecision
    {
        ...
        {
            base.Initialization();
            if (TargetConeOfVision == null) TargetConeOfVision = gameObject.GetComponent<MMConeOfVision>();
        }
        ...
        /// <summary>
        ///     If the MMConeOfVision has at least one target, it becomes our new brain target and this decision is true, otherwise
        ///     it's false.
        /// </summary>
        /// <returns></returns>
        protected virtual bool DetectTarget()
        {
            ...
            {
                if (SetTargetToNullIfNotFound) _brain.Target = null;
                return false;
            }
