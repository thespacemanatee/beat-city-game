...
namespace MoreMountains.TopDownEngine
{
    ...
    public class AIActionMoveRandomly3D : AIAction
    {
        ...
        protected virtual void CheckForObstacles()
        {
            ...
            var hit = Physics.BoxCast(_collider.bounds.center, _collider.bounds.extents, _rayDirection.normalized,
                transform.rotation, ObstaclesDetectionDistance, ObstacleLayerMask);
