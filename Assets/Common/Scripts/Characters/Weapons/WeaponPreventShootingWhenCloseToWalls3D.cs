...
namespace MoreMountains.TopDownEngine
{
    ...
    public class WeaponPreventShootingWhenCloseToWalls3D : WeaponPreventShooting
    {
        ...
        {
            _hitLeft = MMDebug.Raycast3D(transform.position + transform.rotation * RaycastOriginOffset,
                Quaternion.Euler(0f, -Angle / 2f, 0f) * transform.forward, Distance, ObstacleLayerMask, Color.yellow,
                true);
            _hitMiddle = MMDebug.Raycast3D(transform.position + transform.rotation * RaycastOriginOffset,
                transform.forward, Distance, ObstacleLayerMask, Color.yellow, true);
            _hitRight = MMDebug.Raycast3D(transform.position + transform.rotation * RaycastOriginOffset,
                Quaternion.Euler(0f, Angle / 2f, 0f) * transform.forward, Distance, ObstacleLayerMask, Color.yellow,
                true);
