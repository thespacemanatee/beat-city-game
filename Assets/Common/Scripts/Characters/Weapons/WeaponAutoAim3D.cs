...
namespace MoreMountains.TopDownEngine
{
    ...
    public class WeaponAutoAim3D : WeaponAutoAim
    {
            ...
            get
            {
                ...
                if (_topDownController3D != null)
                    _origin += Quaternion.FromToRotation(Vector3.forward,
                        _topDownController3D.CurrentDirection.normalized) * DetectionOriginOffset;
                return _origin;
            }
        }
        ...
        protected override void Initialization()
        {
            ...
            if (_weapon.Owner != null) _topDownController3D = _weapon.Owner.GetComponent<TopDownController3D>();
        }
        ...
        protected override bool ScanForTargets()
        {
            ...
            for (var i = 0; i < min; i++)
            {
                ...
                if (_hits[i].gameObject == gameObject || _hits[i].transform.IsChildOf(transform)) continue;
