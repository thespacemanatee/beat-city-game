...
namespace MoreMountains.TopDownEngine
{
    ...
    /// <summary>
    ///     This class is responsible for enabling/disabling the visual representation of weapons, if they're separated from
    ...
    public class WeaponModelEnabler : MonoBehaviour
    {
        ...
        {
            _characterHandleWeapon = gameObject.GetComponent<CharacterHandleWeapon>();
        }
