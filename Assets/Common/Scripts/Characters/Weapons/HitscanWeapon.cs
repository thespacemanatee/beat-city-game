...
namespace MoreMountains.TopDownEngine
{
    public class HitscanWeapon : Weapon
    {
        ...
        [Tooltip("the max amount of damage to apply to a damageable (something with a Health component) every time there's a hit")]
        public int MinDamageCaused = 5;
        ...
        protected virtual void HandleDamage()
        {
            ...
            else
            {
                ...
                int randomDamage = UnityEngine.Random.Range(MinDamageCaused, Mathf.Max(MaxDamageCaused, MinDamageCaused));
                _health.Damage(randomDamage, this.gameObject, DamageCausedInvincibilityDuration, DamageCausedInvincibilityDuration, _damageDirection);
