...
namespace MoreMountains.TopDownEngine
{
    public class HitscanWeapon : Weapon
    {
        ...
        [Tooltip(
            "the max amount of damage to apply to a damageable (something with a Health component) every time there's a hit")]
        ...
        public virtual void SpawnProjectile(Vector3 spawnPosition, bool triggerObjectActivation = true)
        {
            ...
            if (Mode == Modes.ThreeD)
            {
                ...
                _hit = MMDebug.Raycast3D(_origin, _randomSpreadDirection, HitscanMaxDistance, HitscanTargetLayers,
                    Color.red, true);
        ...
        protected virtual void HandleDamage()
        {
            ...
            else
            {
                ...
                _health.Damage(randomDamage, gameObject, DamageCausedInvincibilityDuration,
                    DamageCausedInvincibilityDuration, _damageDirection);
