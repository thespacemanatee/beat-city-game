...
namespace MoreMountains.TopDownEngine
{
	...
	///     There's a bit of setup involved. You need to have a CharacterHandleWeapon component on your character, it needs an
	///     animator with IKPass active (this is set in the Layers tab of the animator)
    ...
    public class WeaponIK : MonoBehaviour
    {
        ...
        [MMVector("Min", "Max")]
        public Vector2 HeadWeights = new(0f, 1f);
        ...
        /// <summary>
        ///     Detachs the hand from handle, if the IK is not active, set the position and rotation of the hand and head back to
