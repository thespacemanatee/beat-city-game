...
namespace MoreMountains.TopDownEngine
{
    ...
    {
        [Header("Weapon Radius")] public CharacterHandleWeapon TargetHandleWeaponAbility;
        ...
        {
            if (TargetHandleWeaponAbility != null) TargetHandleWeaponAbility.OnWeaponChange -= OnWeaponChange;
        }
        ...
        private void OnWeaponChange()
        {
            ...
            var autoAim = TargetHandleWeaponAbility.CurrentWeapon.GetComponent<WeaponAutoAim>();
