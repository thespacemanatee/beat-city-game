...
namespace MoreMountains.TopDownEngine
{
    ...
    public class MeleeWeapon : Weapon
    {
        ...
        [MMInspectorGroup("Damage Caused", true)]
        ...
        [FormerlySerializedAs("DamageCaused")] [Tooltip("The min amount of health to remove from the player's health")]
        public int MinDamageCaused = 10;

        /// The max amount of health to remove from the player's health
        [FormerlySerializedAs("DamageCaused")] [Tooltip("The max amount of health to remove from the player's health")]
        ...
        public override void Initialization()
        {
            ...
            if (Owner != null) _damageOnTouch.Owner = Owner.gameObject;
        }
        ...
        protected virtual void CreateDamageArea()
        {
            ...
            if (!CanDamageOwner && Owner != null) _damageOnTouch.IgnoreGameObject(Owner.gameObject);
        }
