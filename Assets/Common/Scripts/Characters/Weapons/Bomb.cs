...
namespace MoreMountains.TopDownEngine
{
    ...
    public class Bomb : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if (_timeSinceStart >= TimeBeforeFlicker)
                if (!_flickering && FlickerSprite)
                    ...
                    if (_renderer != null)
                        StartCoroutine(MMImage.Flicker(_renderer, _initialColor, _flickerColor, 0.05f,
                            TimeBeforeExplosion - TimeBeforeFlicker));
            ...
            if (_timeSinceStart >= TimeBeforeExplosion + DamageAreaActiveDuration) DestroyBomb();
        }
        ...
        protected virtual void Initialization()
        {
            ...
            {
                Debug.LogWarning("There's no damage area associated to this bomb : " + name +
                                 ". You should set one via its inspector.");
                return;
            }
            ...
            if (_poolableObject != null) _poolableObject.LifeTime = 0;
        ...
        protected virtual void InstantiateExplosionEffect()
        {
            ...
            {
                var instantiatedEffect = Instantiate(ExplosionEffect, transform.position, transform.rotation);
        ...
        protected virtual void PlayExplosionSound()
        {
            if (ExplosionSfx != null)
                MMSoundManagerSoundPlayEvent.Trigger(ExplosionSfx, MMSoundManager.MMSoundManagerTracks.Sfx,
                    transform.position);
        }
