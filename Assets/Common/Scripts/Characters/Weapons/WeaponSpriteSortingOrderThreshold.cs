...
namespace MoreMountains.TopDownEngine
{
    ...
    public class WeaponSpriteSortingOrderThreshold : MonoBehaviour
    {
        ...
        {
            _weaponAim2D = gameObject.GetComponent<WeaponAim2D>();
        }
        ...
        {
            if (_weaponAim2D == null || Sprite == null) return;

            Sprite.sortingOrder = _weaponAim2D.CurrentAngleRelative > Threshold
