...
namespace MoreMountains.TopDownEngine
{
    ...
    public abstract class WeaponAutoAim : MonoBehaviour
    {
        ...
        {
            if (_aimMarker != null) _aimMarker.Disable();
        }
        ...
        {
            _weaponAim = gameObject.GetComponent<WeaponAim>();
            ...
            FirstTargetFoundFeedback?.Initialization(gameObject);
            NewTargetFoundFeedback?.Initialization(gameObject);
            NoMoreTargetsFeedback?.Initialization(gameObject);
        ...
        {
            if (Target == _targetLastFrame) return;

            if (_aimMarker != null) _aimMarker.SetTarget(Target);
            ...
            if (_targetLastFrame != null && Target != null) NewTargetFound();
        }
        ...
        {
            if (!MoveCameraTarget || Target == null) return;
        ...
        protected virtual void HandleTarget()
        {
            ...
            else
            {
                ...
                if (MoveCameraTarget) _weaponAim.MoveCameraTargetTowardsReticle = false;
                SetAim();
            }
        }
    }
