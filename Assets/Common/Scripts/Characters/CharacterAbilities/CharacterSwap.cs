...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterSwap : CharacterAbility
    {
        ...
        public virtual void SwapToThisCharacter()
        {
            ...
            if (_character.CharacterBrain != null) _character.CharacterBrain.BrainActive = false;
        }

        /// <summary>
        ///     Called when another character replaces this one as the active one, resets its type and player ID and kills its
        ///     input
        /// </summary>
        public virtual void ResetCharacterSwap()
        {
            ...
            if (_character.CharacterBrain != null)
            {
                ...
                if (ResetAIBrainOnSwap) _character.CharacterBrain.ResetBrain();
            }
        }
