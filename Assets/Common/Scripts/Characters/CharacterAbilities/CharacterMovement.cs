...
{
	/// <summary>
	///     Add this ability to a Character to have it handle ground movement (walk, and potentially run, crawl, etc) in x and
	///     z direction for 3D, x and y for 2D
    ...
    public class CharacterMovement : CharacterAbility
    {
        ...
        public override void ProcessAbility()
        {
            ...
            if (!AbilityAuthorized
                || (_condition.CurrentState != CharacterStates.CharacterConditions.Normal && _condition.CurrentState !=
                    CharacterStates.CharacterConditions.ControlledMovement))
                return;
            HandleDirection();
            HandleFrozen();
            HandleMovement();
        ...
        /// </summary>
        /// <param name="value">
        ///     Horizontal move value, between -1 and 1 - positive : will move to the right, negative : will move
        ///     left
        /// </param>
        ...
        protected virtual void HandleMovement()
        {
            ...
            if (ShouldSetMovement) SetMovement();
        }
        ...
        protected virtual void CheckJustGotGrounded()
        {
            ...
            if (_controller.JustGotGrounded) _movement.ChangeState(CharacterStates.MovementStates.Idle);
        }
        ...
        protected virtual void Feedbacks()
        {
            if (_controller.Grounded)
            {
                if (_controller.CurrentMovement.magnitude > IdleThreshold)
                    foreach (var system in WalkParticles)
                    {
                        if (!_walkParticlesPlaying && system != null) system.Play();
            ...
            if (_controller.JustGotGrounded)
            {
                ...
                foreach (var clip in TouchTheGroundSfx)
