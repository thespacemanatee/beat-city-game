...
{
    /// <summary>
    ///     This ability, used on a Player character, will let you click on the ground and have the character move to the
    ///     click's position
    ///     You'll find a demo of this ability on the LoftSuspendersMouseDriven demo character. You can drag it in the Loft3D
    ///     demo scene's LevelManager's PlayerPrefabs slot to give it a try.
    ...
    public class CharacterPathfindToMouse3D : CharacterAbility
    {
        ...
        protected override void Initialization()
        {
            ...
            if (Destination == null)
            {
                ...
                Destination.name = name + "PathfindToMouseDestination";
            }
        }
        ...
        protected virtual void DetectMouse()
        {
            ...
            if (UIShouldBlockInput) testUI = MMGUI.PointOrTouchBlockedByUI();
