...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterButtonActivation : CharacterAbility
    {
        ...
        [MMReadOnly] [Tooltip("the current button activated zone this character is in")]
        ...
        {
            return
                "This component allows your character to interact with button powered objects (dialogue zones, switches...). ";
        }
            ...
            if (InButtonActivatedZone && ButtonActivatedZone != null)
            {
                ...
                switch (ButtonActivatedZone.InputType)
                {
                    case ButtonActivated.InputTypes.Default:
                        buttonPressed = _inputManager.InteractButton.State.CurrentState ==
                                        MMInput.ButtonStates.ButtonDown;
                        break;
                    case ButtonActivated.InputTypes.Button:
                        buttonPressed =
                            Input.GetButtonDown(_character.PlayerID + "_" + ButtonActivatedZone.InputButton);
                        break;
        ...
        protected virtual void ButtonActivation()
        {
                ...
                && _movement.CurrentState != CharacterStates.MovementStates.Dashing)
            {
                ...
                if (ButtonActivatedZone.CanOnlyActivateIfGrounded && !_controller.Grounded) return;
        ...
        {
            RegisterAnimatorParameter(_activatingAnimationParameterName, AnimatorControllerParameterType.Bool,
                out _activatingAnimationParameter);
        }
        ...
        {
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _activatingAnimationParameter, _activating,
