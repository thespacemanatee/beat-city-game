...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterRun : CharacterAbility
    {
        ...
        protected bool _runningStarted;
        ...
        protected override void HandleInput()
        {
            ...
            if (_inputManager.RunButton.State.CurrentState == MMInput.ButtonStates.ButtonDown ||
                _inputManager.RunButton.State.CurrentState == MMInput.ButtonStates.ButtonPressed) RunStart();
        ...
        public virtual void RunStart()
        {
            if (!AbilityAuthorized // if the ability is not permitted
                ...
                CharacterStates.CharacterConditions.Normal // or if we're not in normal conditions
            ...
            if (_characterMovement != null) _characterMovement.MovementSpeed = RunSpeed;
