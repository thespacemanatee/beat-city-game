...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterPause : CharacterAbility
    {
        ...
        {
            if (_inputManager.PauseButton.State.CurrentState == MMInput.ButtonStates.ButtonDown) TriggerPause();
        }
        ...
        {
            if (_condition.CurrentState == CharacterStates.CharacterConditions.Dead) return;
