...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterHandleSecondaryWeapon : CharacterHandleWeapon
    {
        ...
        public override int HandleWeaponID => 2;
        ...
        protected override void HandleInput()
        {
            ...
            if (_inputManager.SecondaryShootButton.State.CurrentState == MMInput.ButtonStates.ButtonDown ||
                _inputManager.SecondaryShootAxis == MMInput.ButtonStates.ButtonDown) ShootStart();
            ...
            if (_inputManager.SecondaryShootButton.State.CurrentState == MMInput.ButtonStates.ButtonUp ||
                _inputManager.SecondaryShootAxis == MMInput.ButtonStates.ButtonUp) ShootStop();

            if (CurrentWeapon != null)
                if (CurrentWeapon.WeaponState.CurrentState == Weapon.WeaponStates.WeaponDelayBetweenUses
                    && _inputManager.SecondaryShootAxis == MMInput.ButtonStates.Off &&
                    _inputManager.SecondaryShootButton.State.CurrentState == MMInput.ButtonStates.Off
