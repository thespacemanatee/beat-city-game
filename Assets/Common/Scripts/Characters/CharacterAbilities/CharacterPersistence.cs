...
namespace MoreMountains.TopDownEngine
{
    ...
    ///     Its health, enabled abilities, component values, equipped weapons, new components you may have added, etc, will all
    ///     remain once in the new scene.
    ///     Animator parameters : None
    /// </summary>
    [AddComponentMenu("Corgi Engine/Character/Abilities/Character Persistence")]
    public class CharacterPersistence : CharacterAbility, MMEventListener<MMGameEvent>,
        MMEventListener<TopDownEngineEvent>
    {
        ...
        {
            if (gameEvent.EventName == "Save") SaveCharacter();
        }
        ...
        public virtual void OnMMEvent(TopDownEngineEvent engineEvent)
        {
            ...
            switch (engineEvent.EventType)
            {
                ...
                case TopDownEngineEventTypes.LevelStart:
                    if (_health != null) _health.StoreInitialPosition();
                    break;
        ...
        protected override void Initialization()
        {
            ...
            if (AbilityAuthorized) DontDestroyOnLoad(gameObject);
