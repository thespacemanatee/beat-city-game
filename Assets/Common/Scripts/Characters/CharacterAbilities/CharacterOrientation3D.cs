...
{
    /// <summary>
    ///     Add this ability to a character, and it'll be able to rotate to face the movement's direction or the weapon's
    ///     rotation
    /// </summary>
    ...
    public class CharacterOrientation3D : CharacterAbility
    {
        ...
        [MMReadOnly] [Tooltip("the direction of the model")]
        public Vector3 ModelDirection;

        /// the direction of the model in angle values
        [MMReadOnly] [Tooltip("the direction of the model in angle values")]
        ...
        /// the current rotation mode
        [MMCondition("ShouldRotateToFaceWeaponDirection", true)] [Tooltip("the current rotation mode")]
        ...
        public Vector3 RelativeSpeed => _relativeSpeed;
        public Vector3 RelativeSpeedNormalized => _relativeSpeedNormalized;
        ...
        protected override void Initialization()
        {
            ...
            if (_model == null && MovementRotatingModel == null && WeaponRotatingModel == null)
                Debug.LogError("CharacterOrientation3D on " + name +
            ...
            if (MovementRotatingModel == null) MovementRotatingModel = _model;
        ...
        public override void ProcessAbility()
        {
            ...
            if (MovementRotatingModel == null && WeaponRotatingModel == null) return;
        ...
        protected virtual void RotateToFaceWeaponDirection()
        {
            ...
            if (LockVerticalRotation) _rotationDirection.y = 0;

            _weaponRotationDirection = _rotationDirection;

            MMDebug.DebugDrawArrow(transform.position, _rotationDirection, Color.red);
        ...
        protected virtual void ComputeRelativeSpeeds()
        {
            ...
            var maxSpeed = 0f;
            if (_characterMovement != null) maxSpeed = _characterMovement.WalkSpeed;
            if (_characterRun != null) maxSpeed = _characterRun.RunSpeed;
            ...
            _yRotationOffsetSmoothed = Mathf.Lerp(_yRotationOffsetSmoothed, _yRotationOffset,
                RotationOffsetSmoothSpeed * Time.deltaTime);
        ...
        protected override void InitializeAnimatorParameters()
        {
            ...
            RegisterAnimatorParameter(_relativeForwardSpeedAnimationParameterName,
                AnimatorControllerParameterType.Float, out _relativeForwardSpeedAnimationParameter);
            RegisterAnimatorParameter(_relativeLateralSpeedAnimationParameterName,
                AnimatorControllerParameterType.Float, out _relativeLateralSpeedAnimationParameter);
            RegisterAnimatorParameter(_remappedForwardSpeedAnimationParameterName,
                AnimatorControllerParameterType.Float, out _remappedForwardSpeedAnimationParameter);
            RegisterAnimatorParameter(_remappedLateralSpeedAnimationParameterName,
                AnimatorControllerParameterType.Float, out _remappedLateralSpeedAnimationParameter);
            ...
            RegisterAnimatorParameter(_remappedSpeedNormalizedAnimationParameterName,
                AnimatorControllerParameterType.Float, out _remappedSpeedNormalizedAnimationParameter);
            RegisterAnimatorParameter(_yRotationOffsetAnimationParameterName, AnimatorControllerParameterType.Float,
                out _yRotationOffsetAnimationParameter);
            RegisterAnimatorParameter(_yRotationOffsetSmoothedAnimationParameterName,
                AnimatorControllerParameterType.Float, out _yRotationOffsetSmoothedAnimationParameter);
        }
        ...
        public override void UpdateAnimator()
        {
            ...
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _relativeForwardSpeedAnimationParameter,
                _relativeSpeed.z, _character._animatorParameters, _character.RunAnimatorSanityChecks);
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _relativeLateralSpeedAnimationParameter,
                _relativeSpeed.x, _character._animatorParameters, _character.RunAnimatorSanityChecks);
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _remappedForwardSpeedAnimationParameter,
                _remappedSpeed.z, _character._animatorParameters, _character.RunAnimatorSanityChecks);
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _remappedLateralSpeedAnimationParameter,
                _remappedSpeed.x, _character._animatorParameters, _character.RunAnimatorSanityChecks);
            ...
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _yRotationOffsetAnimationParameter, _yRotationOffset,
                _character._animatorParameters, _character.RunAnimatorSanityChecks);
            MMAnimatorExtensions.UpdateAnimatorFloat(_animator, _yRotationOffsetSmoothedAnimationParameter,
                _yRotationOffsetSmoothed, _character._animatorParameters, _character.RunAnimatorSanityChecks);
        }
    }
}