...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterRotation2D : CharacterAbility
    {
        ...
        [Tooltip("the current rotation mode")] public RotationSpeeds MovementRotationSpeed = RotationSpeeds.Instant;
        ...
        /// the current rotation mode
        [Tooltip("the current rotation mode")] public RotationSpeeds WeaponRotationSpeed = RotationSpeeds.Instant;
        ...
        protected virtual void RotateToFaceMovementDirection()
        {
            ...
            var angle = Mathf.Atan2(_controller.CurrentDirection.y, _controller.CurrentDirection.x) * Mathf.Rad2Deg;
            ...
            if (MovementRotationSpeed == RotationSpeeds.SmoothAbsolute)
            {
                ...
                {
                    var lastAngle = Mathf.Atan2(_lastMovement.y, _lastMovement.x) * Mathf.Rad2Deg;
        ...
        protected virtual void RotateToFaceWeaponDirection()
        {
            ...
            var angle = Mathf.Atan2(_rotationDirection.y, _rotationDirection.x) * Mathf.Rad2Deg;
        ...
        protected virtual void RotateToFaceForcedRotation()
        {
            if (ForcedRotation)
            {
                var angle = Mathf.Atan2(ForcedRotationDirection.y, ForcedRotationDirection.x) * Mathf.Rad2Deg;
                ...
                if (MovementRotationSpeed == RotationSpeeds.Smooth)
                    ...
                    {
                        _tmpRotation = Quaternion.Euler(angle * Vector3.forward);
                        _newMovementQuaternion = Quaternion.Slerp(MovementRotatingModel.transform.rotation,
                            _tmpRotation, Time.deltaTime * RotateToFaceMovementDirectionSpeed);
                    }
        ...
        protected virtual void RotateModel()
        {
            ...
            if (_shouldRotateTowardsWeapon) WeaponRotatingModel.transform.rotation = _newWeaponQuaternion;
        }
