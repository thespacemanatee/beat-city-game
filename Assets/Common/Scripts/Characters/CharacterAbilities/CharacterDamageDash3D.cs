...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterDamageDash3D : CharacterDash3D
    {
        ...
        protected override void InitializeAnimatorParameters()
        {
            ...
            RegisterAnimatorParameter(_damageDashingAnimationParameterName, AnimatorControllerParameterType.Bool,
                out _damageDashingAnimationParameter);
        }
        ...
        {
            base.UpdateAnimator();
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _damageDashingAnimationParameter,
