...
{
	/// <summary>
	///     Add this ability to a character and it'll be able to jump in 2D. This means no actual movement, only the collider
	///     turned off and on. Movement will be handled by the animation itself.
	/// </summary>
    ...
    public class CharacterJump2D : CharacterAbility
    {
        ...
        [Tooltip("the duration of the jump")] public float JumpDuration = 1f;
