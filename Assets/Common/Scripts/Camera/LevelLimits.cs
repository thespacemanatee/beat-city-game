...
namespace MoreMountains.TopDownEngine
{
    ...
    {
        /// left x coordinate
        [Tooltip("Left x coordinate")] public float LeftLimit;

        /// right x coordinate
        [Tooltip("Right x coordinate")] public float RightLimit;

        /// bottom y coordinate
        [Tooltip("Bottom y coordinate ")] public float BottomLimit;

        /// top y coordinate
        [Tooltip("Top y coordinate")] public float TopLimit;
