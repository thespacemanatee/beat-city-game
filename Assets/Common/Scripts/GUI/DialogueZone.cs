...
namespace MoreMountains.TopDownEngine
{
    ...
    public class DialogueZone : ButtonActivated
    {
        ...
        [Tooltip("the color of the text")] public Color TextColor = Color.white;
        ...
        [Tooltip("the size of the font")] public int TextSize = 40;
        ...
        [Range(1, 100)]
        [Tooltip(
            "The duration for which the message should be displayed, in seconds. only considered if the box is not button handled")]
        ...
        /// the dialogue lines
        [Tooltip("the dialogue lines")] public DialogueElement[] Dialogue;
        ...
        public override void TriggerButtonAction()
        {
            ...
            if (_playing && !ButtonHandled) return;
        ...
        public virtual void StartDialogue()
        {
            ...
            if (_activated && !ActivableMoreThanOnce) return;
            ...
            if (!CanMoveWhileTalking)
            {
                ...
                if (ShouldUpdateState && _characterButtonActivation != null)
                    _characterButtonActivation.GetComponentInParent<Character>().MovementState
                        .ChangeState(CharacterStates.MovementStates.Idle);
            }
            ...
            if (!_playing)
            {
                ...
                // we set its position
                if (_collider2D != null) _dialogueBox.transform.position = _collider2D.bounds.center + Offset;
                if (_collider != null) _dialogueBox.transform.position = _collider.bounds.center + Offset;
                ...
                if (BoxesFollowZone) _dialogueBox.transform.SetParent(gameObject.transform);
                if (TextFont != null) _dialogueBox.DialogueText.font = TextFont;
                if (TextSize != 0) _dialogueBox.DialogueText.fontSize = TextSize;
        ...
        {
            if (_collider2D != null) _collider2D.enabled = status;
            if (_collider != null) _collider.enabled = status;
        }
        ...
        protected virtual IEnumerator PlayNextDialogue()
        {
            ...
            if (_currentIndex >= Dialogue.Length)
            {
                ...
                if (!CanMoveWhileTalking) LevelManager.Instance.UnFreezeCharacters();
            ...
            if (!ButtonHandled) StartCoroutine(AutoNextDialogue());
        }
