...
{
	/// <summary>
	///     This component allows the definition of a level that can then be accessed and loaded. Used mostly in the level map
	///     scene.
	/// </summary>
    ...
    public class LevelSelector : MonoBehaviour
    {
        ...
        public bool DoNotUseLevelManager;
        ...
        {
            if (GameManager.Instance.Paused) TopDownEngineEvent.Trigger(TopDownEngineEventTypes.UnPause, null);
