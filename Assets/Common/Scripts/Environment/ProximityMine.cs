...
namespace MoreMountains.TopDownEngine
{
    ...
    public class ProximityMine : MonoBehaviour
    {
        ...
        public bool WarningStopsOnExit;
        ...
        public bool WarningDurationResetsOnExit;

        /// a read only display of the current duration before explosion
        [Tooltip("a read only display of the current duration before explosion")] [MMReadOnly]
        ...
        {
            if (_inside) TimeLeftBeforeTrigger -= Time.deltaTime;

            if (TimeLeftBeforeTrigger <= 0) TriggerMine();
        }
        ...
        public virtual void TriggerMine()
        {
            ...
            if (DisableMineOnTrigger) gameObject.SetActive(false);
        }
    }
}