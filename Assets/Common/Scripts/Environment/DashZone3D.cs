...
namespace MoreMountains.TopDownEngine
{
    ...
    public class DashZone3D : MonoBehaviour
    {
        ...
        [Tooltip("the duration of the dash")] public float DashDuration;
        ...
        protected bool _dashInProgress;
        ...
        protected virtual void TestForDash(Collider collider)
        {
            ...
            if (_dashInProgress || !DashAuthorized) return;
            ...
            if (_characterDash3D == null) return;
            ...
            _direction1.y = 0f;
            _direction2 = transform.forward.normalized;
            _direction2.y = 0f;

            var angle = Vector3.Angle(_direction1, _direction2);
            if (angle > MaxFacingAngle) return;
        ...
        protected virtual IEnumerator DashSequence()
        {
            ...
            _characterDash3D.DashDirection = transform.forward;
            ...
            if (_characterOrientation3D != null)
            {
                ...
                _characterOrientation3D.ForcedRotationDirection =
                    (transform.position + transform.forward * 10 - transform.position).normalized;
            }
            ...
            if (_characterHandleWeapon != null)
                if (_characterHandleWeapon.CurrentWeapon != null)
                {
                    ...
                    if (_weaponAim3D != null)
                    {
                        ...
                        _weaponAim3D.SetCurrentAim((transform.position + transform.forward * 10 - transform.position)
                            .normalized);
                    }
                }
            ...
            foreach (var dashZone in ExitDashZones) dashZone.SetColliderTrigger(false);
            ...
            if (_weaponAim3D != null) _weaponAim3D.AimControl = _weaponAimControl;
            ...
            foreach (var dashZone in ExitDashZones) dashZone.SetColliderTrigger(true);
