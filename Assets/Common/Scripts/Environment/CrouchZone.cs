...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CrouchZone : MonoBehaviour
    {
        ...
        {
            gameObject.MMGetComponentNoAlloc<Collider>().isTrigger = true;
        }
        ...
        protected virtual void OnTriggerEnter(Collider collider)
        {
            ...
            if (_characterCrouch != null) _characterCrouch.StartForcedCrouch();
        }
        ...
        {
            _characterCrouch = collider.gameObject.MMGetComponentNoAlloc<Character>()?.FindAbility<CharacterCrouch>();
            if (_characterCrouch != null) _characterCrouch.StopForcedCrouch();
        }
    }
}