...
{
    /// <summary>
    ///     Switches can be used to trigger actions based on their current state (on or off). Useful to open doors, chests,
    ///     portals, bridges...
    /// </summary>
    ...
    public class Switch : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            SwitchOffFeedback?.Initialization(gameObject);
            SwitchOnFeedback?.Initialization(gameObject);
            ToggleFeedback?.Initialization(gameObject);
        }
        ...
        {
            if (SwitchAnimator != null) SwitchAnimator.SetBool("SwitchOn", CurrentSwitchState == SwitchStates.On);
        }
        ...
        public virtual void TurnSwitchOn()
        {
            ...
            SwitchOnFeedback?.PlayFeedbacks(transform.position);
        }
        ...
        public virtual void TurnSwitchOff()
        {
            ...
            if (SwitchToggle != null) SwitchToggle.Invoke();
            SwitchOffFeedback?.PlayFeedbacks(transform.position);
        }
        ...
        public virtual void ToggleSwitch()
        {
            ...
            ToggleFeedback?.PlayFeedbacks(transform.position);
        }
    }
}