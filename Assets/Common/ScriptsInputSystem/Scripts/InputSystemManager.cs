...
namespace MoreMountains.TopDownEngine
{
    ...
    public class InputSystemManager : InputManager
    {
        ...
        protected override void Initialization()
        {
            ...
            InputActions.PlayerControls.PrimaryMovement.performed +=
                context => _primaryMovement = context.ReadValue<Vector2>();
            InputActions.PlayerControls.SecondaryMovement.performed +=
                context => _secondaryMovement = context.ReadValue<Vector2>();
            ...
            InputActions.PlayerControls.SecondaryShoot.performed += context =>
            {
            ...
            InputActions.PlayerControls.SwitchWeapon.performed += context =>
            {
                BindButton(context, SwitchWeaponButton);
            };
            InputActions.PlayerControls.SwitchCharacter.performed += context =>
            {
