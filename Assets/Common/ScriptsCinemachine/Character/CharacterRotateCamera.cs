...
{
    /// <summary>
    ///     An ability that will let the Character rotate its associated camera, using the PlayerID_CameraRotationAxis input
    ///     axis
    /// </summary>
    ...
    public class CharacterRotateCamera : CharacterAbility
    {
        ...
        protected float _requestedCameraAngle;
        ...
        protected override void Initialization()
        {
            ...
            if (AutoSetupInputManager)
            {
                ...
                var camera3D = _character.CharacterDimension == Character.CharacterDimensions.Type3D;
        ...
        protected virtual void GetCurrentCamera()
        {
            ...
            if (_brain != null) _virtualCamera = _brain.ActiveVirtualCamera as CinemachineVirtualCamera;
        }
        ...
        {
            _targetRotationAngle = MMMaths.Lerp(_targetRotationAngle, _requestedCameraAngle, CameraInterpolationSpeed,
                Time.deltaTime);

            if (_virtualCamera != null)
            {
                _virtualCamera.transform.Rotate(RotationAxis, _targetRotationAngle, RotationSpace);
                _cameraDirectionAngle = _character.CharacterDimension == Character.CharacterDimensions.Type3D
                    ? _virtualCamera.transform.localEulerAngles.y
                    : _virtualCamera.transform.localEulerAngles.z;
            }
